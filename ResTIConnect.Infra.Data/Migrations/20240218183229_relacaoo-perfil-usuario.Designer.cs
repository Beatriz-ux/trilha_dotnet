...
namespace ResTIConnect.Infra.Data.Migrations
{
    ...
    [Migration("20240218183229_relacaoo-perfil-usuario")]
    partial class relacaooperfilusuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventosSistema", b =>
                {
            ...
            modelBuilder.Entity("SistemaUsuarios", b =>
                {
                    b.Property<int>("SistemasSistemaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResTIConnect.Domain.Entities.Perfil", b =>
                {
                    b.HasOne("ResTIConnect.Domain.Entities.Usuarios", "Usuario")
                        .WithMany("Perfis")
            ...
            modelBuilder.Entity("SistemaUsuarios", b =>
                {
                    ...
                    b.HasOne("ResTIConnect.Domain.Entities.Usuarios", null)
                        .WithMany()
