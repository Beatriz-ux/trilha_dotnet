...
public class TransacaoDB : ITransacaoCollection
{
    ...
    {
        Create(new Transacao { ValorTransacao = 100, DataTransacao = DateTime.Now, TipoTransacao = "Entrada", IdConta = 1, IdCategoria = 1, Categoria = _categorias[0], Conta = _contas[0] });
        Create(new Transacao { ValorTransacao = 200, DataTransacao = DateTime.Now, TipoTransacao = "Saída", IdConta = 2, IdCategoria = 2, Categoria = _categorias[1], Conta = _contas[1] });
        Create(new Transacao { ValorTransacao = 300, DataTransacao = DateTime.Now, TipoTransacao = "Entrada", IdConta = 3, IdCategoria = 3, Categoria = _categorias[2], Conta = _contas[2] });
    }
